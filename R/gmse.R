...
#'@param action_thres A value for the deviation of the estimated population from the manager target, above which manager will not update the policy. Recommended values are between 0 and 1, with the default value being 0.
