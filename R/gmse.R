...
#'@param manage_target This is the target resource abundance that the manager attempts to keep the population at; the default value is 10000.
...
gmse <- function( time_max       = 100,   # Max number of time steps in sim
                  ...
                  user_budget    = 10000, # What is the budget of a user
                  manager_budget = 10000, # The budget of a manager
