...
#'@param manage_target This is the target resource abundance that the manager attempts to keep the population at; the default value is 300.
...
gmse <- function( time_max       = 100,   # Max number of time steps in sim
                  ...
                  lambda         = 0.50,  # Resource growth rate
