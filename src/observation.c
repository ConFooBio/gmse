 ...
 * It is identical to the same function in resource.c, but I'm including it here
 * in the interest of modularity. Eventually, these types of functions might
 * be better moved into their own file, which each higher-level G-MSE function
 * can call.
