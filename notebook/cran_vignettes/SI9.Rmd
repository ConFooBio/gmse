...
sim <- gmse(time_max = 40, land_ownership = TRUE, scaring = FALSE, 
            ...
            feeding = FALSE, tend_crops = FALSE, kill_crops = FALSE, 
            plotting = FALSE, ga_seedrep = 0, user_annealing = FALSE, 
            mana_annealing = FALSE, kmax_annealing = 40, ga_mingen = 40);
```
...
plot(x = ga_fitness_user_cull[,1], y = ga_fitness_user_cull[,2], type = "l", 
     lwd = 2, cex = 0.5, col = "black", pch = 20, ylim = c(1000, 4000), 
...
legend(x = 2500, y = 1700, fill = c("black", "red"),
       legend = c("Genetic Algorithm", "Simulated Annealing"));
text(x = 2000, y = 3900, labels = "Only Culling", cex = 1.25);
```
...
# All options
plot(x = ga_fitness_user_all[1:40,1], y = ga_fitness_user_all[1:40,2], type = "l", 
     lwd = 2, cex = 0.5, col = "black", pch = 20, ylim = c(0, 5000), 
     xlab = "Calls to fitness function", ylab = "Scaled user fitness", xlim = c(0, 4000));
points(x = sa_fitness_user_all[,1], y = sa_fitness_user_cull[,2], 
       type = "l", lwd = 2, cex = 0.5, col = "red", pch = 20);
legend(x = 0, y = 5000, fill = c("black", "red"),
       legend = c("Genetic Algorithm", "Simulated Annealing"));
text(x = 2500, y = 5000, labels = "All actions", cex = 1.25);
```
...
plot(x = ga_fitness_mana_cull[,1], y = ga_fitness_mana_cull[,2] - ofst, 
     ...
     ylim = c(50000, 170000), xlab = "Calls to fitness function", 
     ylab = "Scaled manager fitness", xlim = c(0, 4000));
points(x = sa_fitness_mana_cull[,1], y = sa_fitness_mana_cull[,2] - ofst,
       type = "l", lwd = 2, cex = 0.5, col = "red", pch = 20);
legend(x = 2500, y = 80000, fill = c("black", "red"),
       legend = c("Genetic Algorithm", "Simulated Annealing"));
text(x = 500, y = 165000, labels = "Only Culling", cex = 1.25);
```
...
plot(x = ga_fitness_mana_all[,1], y = ga_fitness_mana_all[,2] - ofst, 
     type = "l",  lwd = 2, cex = 0.5, col = "black", pch = 20, 
     ylim = c(500000, 900000), xlab = "Calls to fitness function", 
     ylab = "Scaled manager fitness", xlim = c(0, 4000));
points(x = sa_fitness_mana_all[,1], y = sa_fitness_mana_all[,2] - ofst,
       type = "l", lwd = 2, cex = 0.5, col = "red", pch = 20);
legend(x = 0, y = 750000, fill = c("black", "red"),
       legend = c("Genetic Algorithm", "Simulated Annealing"));
text(x = 2000, y = 900000, labels = "All actions", cex = 1.25);
```
