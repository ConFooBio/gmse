...
Unlike with the `gmse` function, `gmse_apply` does not automatically assume that crop production should be replenished after a single time step. The second layer of [the landscape](SI7.pdf) holds crop production on a cell. This will be depleted if resources consume crops on the landscape.
