...
<!---
Just re-create the herring 'rec' and 'ssb' data, then read it into an FLquant data type. Then the whole analysis can be done as before, but with access to the data in GMSE. Add the model in too.
--->
...
Frec.m <- FLQuant(ref.m, dimnames=list(age=1, year = 1960:2004))
