...
```{r, echo = TRUE}
sim_1 <- gmse(manager_budget = 10000, user_budget = 10000, plotting = FALSE, 
              res_death_K = 93870, manage_target = 70000, RESOURCE_ini = 35000, 
...
sim_2 <- gmse(manager_budget = 10000, user_budget = 10000, plotting = FALSE, 
              res_death_K = 93870, manage_target = 70000, RESOURCE_ini = 35000, 
              stakeholders = 80, land_ownership = TRUE, public_land = 0.4, 
              scaring = TRUE, lambda = 0.150, remove_pr = 0.122, time_max = 20, 
              res_death_type = 3, res_consume = 0.01, res_birth_K = 200000, 
              observe_type = 3, agent_view = 1);
```
