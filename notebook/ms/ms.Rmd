...
4. We show how GMSE simulates a social-ecological system using the example of a waterfowl population that is adaptively managed; simulated waterfowl exploit agricultural land, causing conflict between conservation interests and the interest of stakeholders (farmers) in maximising crop yield.
