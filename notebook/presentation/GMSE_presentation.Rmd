...
Uncertainty is fundamental in ecological and economic systems, and their measurement

**Natural resources**: Structural and demographic uncertainty

**Resource observation**: Observation uncertainty

**Management**: Implementation uncertainty

**Stake-holder actions**: Pay-off uncertainty
...
## Simple game-theoretic models insufficient
