...
This update includes the major addition of the `observation.c` file, called by `ovbservation.R` to simulate the sampling of resources (i.e., individuals) from the population model. The function `observation.R` **requires** the following three data frames: 
