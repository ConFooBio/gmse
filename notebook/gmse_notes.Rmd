...
This notebook is being written on the 'rev' branch on git, then passed to gh-pages for publication to the ConFooBio group via the command: `git checkout --patch rev gmse_notes.Rmd` from the 'gh-pages' branch.
