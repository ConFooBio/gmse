...
Add some notes on the most recent updates on the dev branch, including the ability to specify the type of category (including ID) that defines which individuals will observe
