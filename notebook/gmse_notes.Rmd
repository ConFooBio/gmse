...
We now have a working G-MSE `v0.0.4`, which includes a stable population model and a stable observation model. 
...
>>>>>>> 1fc8394... Add some notes on the most recent updates on the dev branch, including the ability to specify the type of category (including ID) that defines which individuals will observe
