path <- "~/Desktop/PhD/GitKraken/gmse_fork_RQ1/Budget-ratio-sim/noMem-res/"
setwd(dir = path)
...
# export table
write.csv(tab, file = paste(path, "/merged-res/noMem-budget-ratio-merged.csv", sep = ""))
...
# export table
write.csv(pop, file = paste(path, "/merged-res/pop-noMem-budget-ratio-merged.csv", sep = ""))
...
# export table
write.csv(act, file = paste(path, "/merged-res/act-noMem-budget-ratio-merged.csv", sep = ""))
...
# export table
write.csv(bgt, file = paste(path, "/merged-res/bgt-noMem-budget-ratio-merged.csv", sep = ""))
