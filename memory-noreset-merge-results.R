path <- "~/Desktop/PhD/GitKraken/gmse_fork_RQ1/ATI_NOBONUSRESET/"
setwd(dir = path)
...
# export table
write.csv(tab, file = paste(path, "mem-noreset-merged-results.csv", sep = ""))
...
# export table
write.csv(pop, file = paste(path, "pop-mem-noreset-merged.csv", sep = ""))
...
# export table
write.csv(cos, file = paste(path, "cos-mem-noreset-merged.csv", sep = ""))
...
# export table
write.csv(act, file = paste(path, "act-mem-noreset-merged.csv", sep = ""))
...
# export table
write.csv(bgt, file = paste(path, "bgt-mem-reset-merged.csv", sep = ""))
