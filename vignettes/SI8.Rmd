...
And here the same simulation, except managers update policy only when they observe the population to be plus or minus the target by 20%, and receive a bonus of 30% of their initial budget when they do not.
