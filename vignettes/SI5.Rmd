...
```{r, echo = FALSE, messages = FALSE, cache = FALSE, comment = FALSE, results = "hide"}
library(GMSE);
rec.n        <- read.csv("../notebook/ms/data/SI5/nsher_rec.csv");
ssb.n        <- read.csv("../notebook/ms/data/SI5/nsher_ssb.csv");
yrspan       <- 1960:2004;
rec.m        <- as.matrix(rec.n);
ssb.m        <- as.matrix(ssb.n);
