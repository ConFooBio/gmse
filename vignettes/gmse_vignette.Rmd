...
We have described the initial release of GMSE.

The `GMSE` package is under further development to include additional features that will be of interest to conservation biologists.
