...
1. FIXIT: General statment about population management and biodiversity, social-ecological complexity, uncertainty, etc.
2. We present the R package GMSE, which generalises traditional Management Strategy Evaluation using genetic algorithms to simulate adaptive management scenarios under complex social-ecological interactions and uncertainty.
3. FIXIT: GMSE is individual/agent-based and spatially explicit, and incorporates more social-ecological realism and uncertainty through mechanistic modelling than previous models
4. FIXIT: We show how GMSE can be used to simulate a social-ecological system
...
- Paragraph introducing the uncertainty inherent to social-ecological systems. Introduce adaptive management, then management strategy evaluation framework [@Bunnefeld2011]; introduce this *generalised* management strategy evaluation framework and R package as filling an important gap in tools available for modelling mangement.

- Get uncertainty and stochasticity in here somehow (Nil's book)
